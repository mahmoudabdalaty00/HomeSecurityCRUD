...
namespace Server.Migrations
{
    ...
    [Migration("20250505194244_updates2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Models.Entities.AIVIsitorData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Server.Models.Entities.Photo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("AIVIsitorDataId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Server.Models.Entities.Photo", b =>
                {
                    b.HasOne("Server.Models.Entities.AIVIsitorData", null)
                        .WithMany("PhotoPath")
                        .HasForeignKey("AIVIsitorDataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
